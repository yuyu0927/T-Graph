...
def get_parser():
    ...
    parser.add_argument("--dataset", type=str, default="co3d_rt")
        ...
        while self.iteration < self.num_iterations:
            for batch in self.dataloader:
                ...
                with torch.autocast(
                    ...
                    truth_graph = batch["relative_translation"].to(self.device, non_blocking=True)
                    ...
                    loss_trans_graph = l1(predicted_translations_graph, truth_graph) / n_c * n
